...
// redirect back to candidates
 header("Location: ad_candidates.php");
}
?>
<?php
// deleting sql query
...
<title>Admin Control Panel - Candidates</title>
...
<div id="header">
  ...
  <a href="admin.php">Home</a> | <a href="ad_positions.php">Manage Positions</a> | <a href="ad_candidates.php">Manage Candidates</a> | <a href="ad_refresh.php">Poll Results</a> | <a href="ad_manageadmins.php">Manage Account</a> | <a href="ad_changepassword.php">Change Password</a>  | <a href="ad_logout.php">Logout</a>
</div>
<div id="container">
<table width="380" align="center">
<CAPTION><h3>ADD NEW CANDIDATE</h3></CAPTION>
<form name="fmCandidates" id="fmCandidates" action="ad_candidates.php" method="post" onsubmit="return candidateValidate(this)">
<tr>
...
echo '<td><a href="ad_candidates.php?id=' . $row['candidate_id'] . '">Delete Candidate</a></td>';
echo "</tr>";
$inc++;
}
