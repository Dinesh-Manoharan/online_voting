...
// redirect back to positions
 header("Location: ad_positions.php");
}
?>
<?php
// deleting sql query
...
<form name="fmPositions" id="fmPositions" action="ad_positions.php" method="post" onsubmit="return positionValidate(this)">
<tr>
    <td>Position Name</td>
...
echo '<td><a href="ad_positions.php?id=' . $row['position_id'] . '">Delete Position</a></td>';
echo "</tr>";
$inc++;
}
