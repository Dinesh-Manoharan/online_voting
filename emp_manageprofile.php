...
$myId = addslashes( $_GET['member_id']);
...
// redirect back to profile
 header("Location: emp_manageprofile.php");
}
?>
...
<div id="header">
  ...
  <ul> 
  <li><a href="employee.php">Home</a> </li> <li><a href="emp_vote.php">Current Polls</a> </li> <li><a href="emp_manageprofile.php">Manage My Profile</a> </li> <li><a href="emp_changepassword.php">Change Password</a></li> <li><a href="emp_logout.php">Logout</a></li>
  </ul></div>
<div id="container">
<table border="0" width="620" align="center">
<CAPTION><h3>UPDATE PROFILE</h3></CAPTION>
<form action="emp_manageprofile.php?id=<?php echo $_SESSION['member_id']; ?>" method="post" onsubmit="return updateProfile(this)">
<table align="center">
