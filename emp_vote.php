...
<title>E-Voting System - Voting Page</title>
...
xmlhttp.open("GET","emp_vote.php?position="+String,true);
xmlhttp.send();
}
</script>
<script type="text/javascript">
...
<body bgcolor="#87CEEB">
<center>
<b><font color = "brown" size="6">E-voting System</font></b></center><br><br>
<body>
<div id="page">
<div id="header">
  <h1>CURRENT POLLS</h1>
  <a href="employee.php">Home</a> | <a href="emp_vote.php">Current Polls</a> | <a href="emp_manageprofile.php">Manage My Profile</a> | <a href="emp_changepassword.php">Change Password</a>| <a href="emp_logout.php">Logout</a>
</div>
<div class="refresh">
</div>
<div id="container">
<table width="420" align="center">
<form name="fmNames" id="fmNames" method="post" action="emp_vote.php" onSubmit="return positionValidate(this)">
<tr>
...
?>
<tr>
    <h3>Welcome to Voting Segment!
      Vote for a person who do you think had done their job well in this annual year
      The winners will get award on the Annual celebration day! 
    </h3>
    <td>&nbsp;</td>
</tr>
</form>
