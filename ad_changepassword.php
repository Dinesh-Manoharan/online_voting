...
<li><a href="admin.php">Home</a></li> <li> <a href="ad_positions.php">Manage Positions</a></li> <li> <a href="ad_candidates.php">Manage Candidates</a></li> <li> <a href="ad_refresh.php">Poll Results</a></li><li><a href="ad_manage-admins.php">Manage Account</a></li><li> <a href="ad_changepassword.php">Change Password</a></li><li> <a href="ad_logout.php">Logout</a></li>
</ul></div>
<div id="container">
<?php
...
<tr>
<td>
<form action="ad_changepassword.php?id=<?php echo $_SESSION['admin_id']; ?>" method="post" onSubmit="return updateProfile(this)">
<table align="center">
